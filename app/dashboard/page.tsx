...
export default function DashboardHome() {
	return (
		<section
			id="home"
			className="md:mt-20 h-screen md:h-auto pb-12 md:pb-0 ps-8 md:ps-0 md:pt-0 hero flex flex-col-reverse gap-5 lg:flex-row  lg:mt-8 relative md:z-40 px-3 mb-0"
		>
