...
export default function Projects() {
  const { projectsRef } = useTheme();
  // const section1Ref = useRef(null);

  const isInView1 = useInView(projectsRef, { once: true });
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-700 dark:text-white">
        These are the list of projects that I have worked on and with a brief
        detail about each
      </p>
          ...
          >
            ...
            >
              <Image
                ...
                alt={props.siteName}
              />
              <p className="bg-custom-gradient text-gray-900 font-semibold dark:text-white p-3 text-center w-full">
                {props.projectName}
              </p>
            </div>
            <div
            ...
            >
              <h1 className="font-semibold dark:text-white">DESCRIPTION</h1>
              ...
              {props.server && (
                <p className="dark:text-white">
                  <span className="roboto-condensed-400">Server-side:</span>{" "}
                  {props.server}
                </p>
              )}
              <p className="dark:text-white">
                <span className="roboto-condensed-400">Client-side:</span>{" "}
                {props.client}
              </p>
              <p className="dark:text-white">
                <span className="roboto-condensed-400">Project type:</span>{" "}
                {props.projectType}
              </p>
            </div>
